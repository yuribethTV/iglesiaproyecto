...
@section('content')
<a href="{{url('/crearmiembroadultos')}}" class="btn btn-info">Crear miembro
</a>
@csrf
<table class='table'>
    <th> Cedula</th>
...
@foreach ($adultos as $i)
   ...
   <td> <a href="{{ url('/modificaradultos')}}/{{$i->id}}" class="btn btn-xs btn-info"> Editar <span class="glyphicon glyphicon-pencil"> </span> </a>  
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form id="formularioeliminar"  method="post" action="{{url('/borraradultos') }}">
        @csrf
