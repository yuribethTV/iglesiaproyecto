...
@section('content')
<a href="{{url('/crearingresos')}}" class="btn btn-info">Crear Ingreso
</a>
<form action="{{url('/ingresosfecha')}}" method="post">
@csrf
...
@foreach ($ingresos as $i)
   ...
   <td> <a href="{{ url('/modificaringreso')}}/{{$i->id}}" class="btn btn-xs btn-info"> Editar <span class="glyphicon glyphicon-pencil"> </span> </a>  
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form id="formularioeliminar"  method="post" action="{{url('/borraringresos') }}">
        @csrf
